 ...
 * FreeRTOSConfig.h for x86-64 native (bare-metal on QEMU)
 */
...
/* On x86, we use a simple cli/sti model. Priority value doesn't matter much. */
...
/* x86 doesn't have a GIC, but the port code needs these */
