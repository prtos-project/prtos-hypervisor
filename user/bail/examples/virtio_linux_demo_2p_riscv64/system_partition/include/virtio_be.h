 ...
 *
 * RISC-V 64 version: Shared memory addresses for PRTOS hw-virt on RISC-V.
 *
 * Shared Memory Regions (5 separate areas, mapped by both partitions):
 *   Virtio_Net0:  1MB   @ IPA 0x98000000
 *   Virtio_Net1:  1MB   @ IPA 0x98100000
 *   Virtio_Net2:  1MB   @ IPA 0x98200000
 *   Virtio_Blk:   2MB   @ IPA 0x98300000
 *   Virtio_Con:   256KB @ IPA 0x98500000
 */
...
/* ============================================================================
 * Shared Memory Base Addresses (IPA, identity-mapped via G-stage)
 * ============================================================================ */

#define VIRTIO_NET0_BASE        0x98000000UL
#define VIRTIO_NET0_SIZE        0x00100000UL    /* 1MB */

#define VIRTIO_NET1_BASE        0x98100000UL
#define VIRTIO_NET1_SIZE        0x00100000UL    /* 1MB */

#define VIRTIO_NET2_BASE        0x98200000UL
#define VIRTIO_NET2_SIZE        0x00100000UL    /* 1MB */

#define VIRTIO_BLK_BASE         0x98300000UL
#define VIRTIO_BLK_SIZE         0x00200000UL    /* 2MB */

#define VIRTIO_CON_BASE         0x98500000UL
#define VIRTIO_CON_SIZE         0x00040000UL    /* 256KB */

#define VIRTIO_NUM_NET          3
#define VIRTIO_NUM_DEVICES      5

/* ============================================================================
 * IPVI Doorbell Vector Numbers
 * ============================================================================ */
...
#define IPVI_BLK                3
#define IPVI_CON                4
#define IPVI_SYS_TO_GUEST       5

/* ============================================================================
 * Common Virtio Constants
 * ============================================================================ */

#define VIRTIO_PRTOS_MAGIC      0x50525456UL
...
#define VIRTIO_NET_MAGIC            0x4E455430UL
...
#define VIRTIO_BLK_MAGIC            0x424C4B30UL
...
#define VIRTIO_CONSOLE_MAGIC        0x434F4E53UL
