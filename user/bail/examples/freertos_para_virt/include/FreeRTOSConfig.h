/*
 * FreeRTOS configuration for PRTOS hw-virt partition.
 * Based on the original CORTEX_A57 config with GIC MMIO references removed.
 */
...
/* GIC: system register access, no MMIO base needed.
 * configINTERRUPT_CONTROLLER_BASE_ADDRESS is NOT defined - we use
 * ICC_* system registers instead. */
