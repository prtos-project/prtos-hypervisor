 ...
 * FILE: prtos_hv.h
 *
 * PRTOS Hypervisor Interface for Linux guests running under VMX.
 *
 * Uses vmcall instruction to issue PRTOS hypercalls directly from userspace.
 * vmcall causes an unconditional VM exit regardless of CPL, so it works
 * from ring 3 (userspace) in VMX non-root mode.
 *
...
/* ============================================================================
 * PRTOS Hypercall Numbers (from core/include/amd64/hypercalls.h)
 * ============================================================================ */
...
/* ============================================================================
 * PRTOS Return Codes (from core/include/hypercalls.h)
 * ============================================================================ */
...
/* ============================================================================
 * PRTOS Status Definitions (from core/include/objects/status.h)
 * ============================================================================ */
...
/* ============================================================================
 * Object Descriptor Macros (from core/include/objdir.h)
 * ============================================================================ */
...
/* Object descriptor bit layout (from core/include/objdir.h):
 * [31] validity | [30:24] class (7b) | [23:20] vcpuid (4b) | [19:10] partid (10b) | [9:0] id (10b) */
...
/* ============================================================================
 * Status Structures (from core/include/objects/status.h)
 * ============================================================================ */
...
/* Union used by ctrl_object for status queries */
typedef union {
    union {
...
/* Initialize the hypervisor interface. Must be called before other functions.
 * Sets up the shared memory mailbox mapping.
...
/* Inter-partition virtual interrupt */
...
/* Number of partitions (discovered by probing) */
