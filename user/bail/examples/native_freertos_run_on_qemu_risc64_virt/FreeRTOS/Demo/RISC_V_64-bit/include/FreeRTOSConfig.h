 ...
 *
 * FreeRTOSConfig.h for RISC-V 64-bit on QEMU virt
 */
...
/* RISC-V does not use GIC interrupt priorities.
 * These are defined as dummy values to satisfy FreeRTOS core code references. */
