...
extern struct prtos_conf_part_line_number *prtos_conf_partition_table_line_number;
...
#define C_PART_PHYSMEMAREA (partition_table[C_PARTITION].num_of_physical_memory_areas - 1)
#define C_RSW_PHYSMEMAREA (prtos_conf.rsw.num_of_physical_memory_areas - 1)
#define C_PART_VIRTMEMAREA (partition_table[C_PARTITION].noVirtualMemoryAreas - 1)
#define C_PART_IOPORT (partition_table[C_PARTITION].num_of_io_ports - 1)
#define C_PART_COMMPORT (partition_table[C_PARTITION].num_of_ports - 1)
