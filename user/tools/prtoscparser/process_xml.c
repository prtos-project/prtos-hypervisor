...
#endif
#if defined(CONFIG_DEV_UART) || defined(CONFIG_DEV_UART_MODULE) || defined(CONFIG_AARCH64) || defined(CONFIG_riscv64) || defined(CONFIG_loongarch64)  // FIXME: Here is WA for aarch64 build
                                           &uart_device_node,
#endif
#if defined(CONFIG_x86) || defined(CONFIG_amd64)
                                           &vga_device_node,
