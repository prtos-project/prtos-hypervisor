...
HOST_CFLAGS = -Wall -O2 -D$(ARCH) -I$(LIBPRTOS_PATH)/include -DHOST -D"__PRTOS_INCFLD(_fld)=<prtos_inc/_fld>" -fno-strict-aliasing
HOST_LDFLAGS =
...
TARGET_CFLAGS += -I$(LIBPRTOS_PATH)/include --include prtos_inc/config.h --include prtos_inc/arch/arch_types.h
...
TARGET_ASFLAGS += -I$(LIBPRTOS_PATH)/include -nostdlib -nostdinc --include prtos_inc/config.h
