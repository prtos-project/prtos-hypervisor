...
__stdcall prtos_s32_t prtos_set_timer(prtos_u32_t clock_id, prtos_time_t abstime, prtos_time_t interval) {
    prtos_s32_t _r;
    _PRTOS_HCALL5(clock_id, abstime, abstime >> 32, interval, interval >> 32, set_timer_nr, _r);
    return _r;
}
