 ...
 *
 * Arch hypercalls definition for amd64
 *
 * www.prtos.org
 */
...
/* Use software interrupt for hypercalls in long mode */
#define __DO_PRTOSHC "int $0x82"

#define _PRTOS_HCALL0(_hc_nr, _r) __asm__ __volatile__(__DO_PRTOSHC : "=a"(_r) : "0"((prtos_u64_t)(_hc_nr)) : "memory")

#define _PRTOS_HCALL1(_a0, _hc_nr, _r) __asm__ __volatile__(__DO_PRTOSHC : "=a"(_r) : "0"((prtos_u64_t)(_hc_nr)), "b"((prtos_u64_t)(_a0)) : "memory")

#define _PRTOS_HCALL2(_a0, _a1, _hc_nr, _r) __asm__ __volatile__(__DO_PRTOSHC : "=a"(_r) : "0"((prtos_u64_t)(_hc_nr)), "b"((prtos_u64_t)(_a0)), "c"((prtos_u64_t)(_a1)) : "memory")

#define _PRTOS_HCALL3(_a0, _a1, _a2, _hc_nr, _r) \
    __asm__ __volatile__(__DO_PRTOSHC : "=a"(_r) : "0"((prtos_u64_t)(_hc_nr)), "b"((prtos_u64_t)(_a0)), "c"((prtos_u64_t)(_a1)), "d"((prtos_u64_t)(_a2)) : "memory")

#define _PRTOS_HCALL4(_a0, _a1, _a2, _a3, _hc_nr, _r) \
    __asm__ __volatile__(__DO_PRTOSHC                 \
                         : "=a"(_r)                   \
                         : "0"((prtos_u64_t)(_hc_nr)), "b"((prtos_u64_t)(_a0)), "c"((prtos_u64_t)(_a1)), "d"((prtos_u64_t)(_a2)), "S"((prtos_u64_t)(_a3)) : "memory")

#define _PRTOS_HCALL5(_a0, _a1, _a2, _a3, _a4, _hc_nr, _r)                                                                                  \
    __asm__ __volatile__(__DO_PRTOSHC                                                                                                       \
                         : "=a"(_r)                                                                                                         \
                         : "0"((prtos_u64_t)(_hc_nr)), "b"((prtos_u64_t)(_a0)), "c"((prtos_u64_t)(_a1)), "d"((prtos_u64_t)(_a2)), "S"((prtos_u64_t)(_a3)), \
                           "D"((prtos_u64_t)(_a4)) : "memory")
