# AArch64 (ARMv8) Platform — API Reference
...
- **EL2 Exception Level**: PRTOS runs at EL2 (Hypervisor), guests run at EL1 (Kernel)
- **Stage-2 Page Tables**: Hardware-enforced memory isolation via VTTBR_EL2
- **GICv3 Virtual Interrupts**: Virtual interrupt injection via ICH_LR registers, List Registers for pending interrupts
- **Trap-and-Emulate**: Sensitive instructions trapped to EL2 for emulation

### ARM-Specific Registers

| Register | Description |
|---|---|
| `HCR_EL2` | Hypervisor Configuration Register (controls trap routing) |
| `VTTBR_EL2` | Virtual Translation Table Base Register (Stage-2 page table pointer) |
| `ICH_LR<n>_EL2` | List Registers (GICv3 virtual interrupt injection) |
| `CNTVOFF_EL2` | Counter-timer Virtual Offset (virtual timer offset) |
...
- [*Embedded Hypervisor: Architecture, Principles, and Implementation*](http://www.prtos.org/embedded_hypervisor_book/) — for the theoretical foundations of ARM virtualization and GICv3 virtual interrupt injection
