...
void __VBOOT setup_gdt(prtos_s32_t cpu_id) {
    ...
    gdt_table[GDT_ENTRY(cpu_id, PRTOS_HYPERCALL_CALLGATE_SEL)].offset15_0 = (prtos_address_t)asm_hypercall_dispatch & 0xffff;
    ...
    gdt_table[GDT_ENTRY(cpu_id, PRTOS_HYPERCALL_CALLGATE_SEL)].offset31_16 = ((prtos_address_t)asm_hypercall_dispatch & 0xffff0000) >> 16;
