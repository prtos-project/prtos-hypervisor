 ...
 * FILE: processor.h
 *
 * Processor definitions for amd64
 *
 * www.prtos.org
 */
...
#define _MSR_EFER_SCE (1 << 0)
#define _MSR_EFER_LME (1 << 8)
#define _MSR_EFER_LMA (1 << 10)
#define _MSR_EFER_NXE (1 << 11)
