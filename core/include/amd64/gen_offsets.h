...
static inline void generate_offsets(void) {
    ...
    DEFINE(bx, offsetof(cpu_ctxt_t, bx), );
    DEFINE(cx, offsetof(cpu_ctxt_t, cx), );
    DEFINE(dx, offsetof(cpu_ctxt_t, dx), );
    DEFINE(si, offsetof(cpu_ctxt_t, si), );
    DEFINE(di, offsetof(cpu_ctxt_t, di), );
    DEFINE(ip, offsetof(cpu_ctxt_t, ip), );
    DEFINE(sp, offsetof(cpu_ctxt_t, sp), );
