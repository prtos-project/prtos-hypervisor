 ...
 * FILE: arch_types.h
 *
 * Types defined by the amd64 architecture
 *
 * www.prtos.org
 */
...
// Extended types
#define PRTOS_LOG2_WORD_SZ 6
typedef prtos_s64_t prtos_time_t;
#define MAX_PRTOSTIME MAX_S64
typedef long prtos_long_t;
typedef prtos_u64_t prtos_word_t;
typedef prtos_u32_t prtos_id_t;
typedef prtos_u64_t prtos_address_t;
typedef prtos_u16_t prtos_io_address_t;
typedef prtos_u64_t prtos_u_size_t;
typedef prtos_s64_t prtos_s_size_t;

#define PRNT_ADDR_FMT "ll"
#define PTR2ADDR(x) ((prtos_word_t)(unsigned long)(x))
