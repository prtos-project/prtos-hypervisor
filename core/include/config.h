...
#define __PRTOS_XSTR(x) #x
#define __PRTOS_STR(x) __PRTOS_XSTR(x)
#define PRTOS_HV_VERSION_STRING __PRTOS_STR(CONFIG_PRTOS_VERSION) "." __PRTOS_STR(CONFIG_PRTOS_SUBVERSION)
