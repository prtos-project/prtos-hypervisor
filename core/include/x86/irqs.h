...
extern void fix_stack(cpu_ctxt_t *ctxt, part_ctl_table_t *part_ctrl_table, prtos_s32_t irq_nr, prtos_s32_t vector, prtos_s32_t trap);

static inline prtos_s32_t arch_emul_trap_irq(cpu_ctxt_t *ctxt, part_ctl_table_t *part_ctrl_table, prtos_s32_t irq_nr) {
...
static inline prtos_s32_t arch_emul_hw_irq(cpu_ctxt_t *ctxt, part_ctl_table_t *part_ctrl_table, prtos_s32_t irq_nr) {
...
static inline prtos_s32_t arch_emul_ext_irq(cpu_ctxt_t *ctxt, part_ctl_table_t *part_ctrl_table, prtos_s32_t irq_nr) {
