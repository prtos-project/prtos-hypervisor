...
#define PRTOS_PACKAGE_SIGNATURE 0x24584354  // $XCT
    prtos_u32_t version;
#define PRTOS_PACK_VERSION 1
#define PRTOS_PACK_SUBVERSION 0
#define PRTOS_PACK_REVISION 0
    prtos_u32_t flags;
...
#define PEF_SUBVERSION 0
#define PEF_REVISION 0

struct pef_hdr {
#define PEF_SIGNATURE 0x24584546
    prtos_u32_t signature;
    prtos_u32_t version;
#define PEF_DIGEST 0x1
#define PEF_COMPRESSED 0x4
#define PEF_RELOCATABLE 0x10

#define PEF_TYPE_MASK 0xc0
#define PEF_TYPE_HYPERVISOR 0x00
#define PEF_TYPE_PARTITION 0x40
#define PEF_TYPE_CUSTOMFILE 0x80

#define PEF_ARCH_ARMV8 0x400
#define PEF_ARCH_MASK 0xff00
    prtos_u32_t flags;
    prtos_u8_t digest[PRTOS_DIGEST_BYTES];
