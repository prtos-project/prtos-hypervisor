...
/*
 * Standard entry type that we'll use to build PRTOS's own pagetables.
 ...
 * However PRTOS only supports 16GB of RAM on 32-bit ARM systems and
 * therefore 39-bits are sufficient.
 */

#define PRTOS_PT_LPAE_SHIFT         LPAE_SHIFT_GS(PAGE_SHIFT)
#define PRTOS_PT_LPAE_ENTRIES       LPAE_ENTRIES_GS(PAGE_SHIFT)
#define PRTOS_PT_LPAE_ENTRY_MASK    LPAE_ENTRY_MASK_GS(PAGE_SHIFT)

#define PRTOS_PT_LEVEL_SHIFT(lvl)   LEVEL_SHIFT_GS(PAGE_SHIFT, lvl)
#define PRTOS_PT_LEVEL_ORDER(lvl)   LEVEL_ORDER_GS(PAGE_SHIFT, lvl)
#define PRTOS_PT_LEVEL_SIZE(lvl)    LEVEL_SIZE_GS(PAGE_SHIFT, lvl)
#define PRTOS_PT_LEVEL_MASK(lvl)    (~(PRTOS_PT_LEVEL_SIZE(lvl) - 1))

/* Convenience aliases */
#define THIRD_SHIFT         PRTOS_PT_LEVEL_SHIFT(3)
#define THIRD_ORDER         PRTOS_PT_LEVEL_ORDER(3)
#define THIRD_SIZE          PRTOS_PT_LEVEL_SIZE(3)
#define THIRD_MASK          PRTOS_PT_LEVEL_MASK(3)

#define SECOND_SHIFT        PRTOS_PT_LEVEL_SHIFT(2)
#define SECOND_ORDER        PRTOS_PT_LEVEL_ORDER(2)
#define SECOND_SIZE         PRTOS_PT_LEVEL_SIZE(2)
#define SECOND_MASK         PRTOS_PT_LEVEL_MASK(2)

#define FIRST_SHIFT         PRTOS_PT_LEVEL_SHIFT(1)
#define FIRST_ORDER         PRTOS_PT_LEVEL_ORDER(1)
#define FIRST_SIZE          PRTOS_PT_LEVEL_SIZE(1)
#define FIRST_MASK          PRTOS_PT_LEVEL_MASK(1)

#define ZEROETH_SHIFT       PRTOS_PT_LEVEL_SHIFT(0)
#define ZEROETH_ORDER       PRTOS_PT_LEVEL_ORDER(0)
#define ZEROETH_SIZE        PRTOS_PT_LEVEL_SIZE(0)
...
lpae_t __aligned(PAGE_SIZE) __section(".data.page_aligned")                   \
    name[PRTOS_PT_LPAE_ENTRIES * (nr)]

#define DEFINE_BOOT_PAGE_TABLE(name) DEFINE_BOOT_PAGE_TABLES(name, 1)

#define DEFINE_PAGE_TABLES(name, nr)                    \
lpae_t __aligned(PAGE_SIZE) name[PRTOS_PT_LPAE_ENTRIES * (nr)]
