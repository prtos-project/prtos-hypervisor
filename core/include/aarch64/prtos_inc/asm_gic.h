...
extern void gic_route_irq_to_prtos(struct irq_desc *desc, unsigned int priority);
...
extern void init_maintenance_interrupt_prtos(void);
 ...
 * guest. The flow of interrupts routed to PRTOS is not able cope with
