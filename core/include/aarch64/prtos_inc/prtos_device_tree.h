 ...
 */
#ifndef __PRTOS_DEVICE_TREE_H__
#define __PRTOS_DEVICE_TREE_H__

#include <asm_byteorder.h>
#include <asm_generic_device.h>
#include <public_prtos.h>
#include <public_device_tree_defs.h>
#include <prtos_bug.h>
 ...
 * path from the guest
 *
 * @u_path: PRTOS Guest handle to the buffer containing the path
...
#define dt_dprintk(fmt, args...)  \
    printk(PRTOSLOG_DEBUG fmt, ## args)
#else
static inline void
