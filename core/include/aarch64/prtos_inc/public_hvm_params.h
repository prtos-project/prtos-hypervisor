...
#ifndef __PRTOS_PUBLIC_HVM_PARAMS_H__
#define __PRTOS_PUBLIC_HVM_PARAMS_H__
...
#define HVM_PARAM_CALLBACK_IRQ_TYPE_MASK prtos_mk_ullong(0xFF00000000000000)
/*
...
/*
 * val[7:0] is a vector number.  Check for PRTOSFEAT_hvm_callback_vector to know
...
/*
 * These are not used by PRTOS. They are here for convenience of HVM-guest
 ...
 * original 'base' set exposed in releases prior to PRTOS 4.4.
 */
...
#define PRTOS_ALTP2M_disabled      0
#define PRTOS_ALTP2M_mixed         1
#define PRTOS_ALTP2M_external      2
#define PRTOS_ALTP2M_limited       3
...
#define PRTOS_HVM_MCA_CAP_LMCE   (prtos_mk_ullong(1) << 0)
#define PRTOS_HVM_MCA_CAP_MASK   PRTOS_HVM_MCA_CAP_LMCE

#define HVM_NR_PARAMS 39

#endif /* __PRTOS_PUBLIC_HVM_PARAMS_H__ */
