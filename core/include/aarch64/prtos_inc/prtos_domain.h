...
#ifndef __PRTOS_DOMAIN_H__
#define __PRTOS_DOMAIN_H__
...
int default_initialise_vcpu(struct vcpu *v, PRTOS_GUEST_HANDLE_PARAM(void) arg);
...
extern unsigned int prtos_processor_pmbits;
...
struct vnuma_info {
    ...
    struct prtos_vmemrange *vmemrange;
};
