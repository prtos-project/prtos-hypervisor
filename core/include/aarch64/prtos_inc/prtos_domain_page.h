 ...
 * domain_page.h
 * 
 * Allow temporary mapping of domain page frames into PRTOS space.
 * 
 * Copyright (c) 2003-2006, Keir Fraser <keir@xensource.com>
 */

#ifndef __PRTOS_DOMAIN_PAGE_H__
#define __PRTOS_DOMAIN_PAGE_H__
