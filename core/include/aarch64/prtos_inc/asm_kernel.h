 ...
 *
 * DOM0LESS_ENHANCED_NO_XS: Notify the OS it is running on top of PRTOS. All the
 *                          default features (excluding PRTOSstore) will be
 *                          available. Note that an OS *must* not rely on the
 *                          availability of PRTOS features if this is not set.
 * DOM0LESS_PRTOSSTORE:       PRTOSstore will be enabled for the VM. This feature
 *                          can't be enabled without the
 *                          DOM0LESS_ENHANCED_NO_XS.
 * DOM0LESS_ENHANCED:       Notify the OS it is running on top of PRTOS. All the
 *                          default features (including PRTOSstore) will be
 *                          available. Note that an OS *must* not rely on the
 *                          availability of PRTOS features if this is not set.
 */
#define DOM0LESS_ENHANCED_NO_XS  BIT(0, U)
#define DOM0LESS_PRTOSSTORE        BIT(1, U)
#define DOM0LESS_ENHANCED        (DOM0LESS_ENHANCED_NO_XS | DOM0LESS_PRTOSSTORE)
