...
#ifndef __PRTOS_PUBLIC_TRACE_H__
#define __PRTOS_PUBLIC_TRACE_H__
...
#define TRC_SCHED    0x0002f000    /* PRTOS Scheduler trace      */
#define TRC_DOM0OP   0x0004f000    /* PRTOS DOM0 operation trace */
#define TRC_HVM      0x0008f000    /* PRTOS HVM trace            */
#define TRC_MEM      0x0010f000    /* PRTOS memory trace         */
#define TRC_PV       0x0020f000    /* PRTOS PV traces            */
#define TRC_SHADOW   0x0040f000    /* PRTOS shadow tracing       */
#define TRC_HW       0x0080f000    /* PRTOS hardware-related traces */
...
/* #define PRTOS_SCHEDULER_SEDF 2 (Removed) */
...
#define TRC_HVM_PF_PRTOS          (TRC_HVM_HANDLER + 0x01)
#define TRC_HVM_PF_PRTOS64        (TRC_HVM_HANDLER + TRC_64_FLAG + 0x01)
...
struct t_buf {
    ...
    uint32_t prod;   /* Offset of next item to be produced by PRTOS.           */
...
#endif /* __PRTOS_PUBLIC_TRACE_H__ */
