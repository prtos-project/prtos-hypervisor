...
#ifndef __PRTOS_LIVEPATCH_H__
#define __PRTOS_LIVEPATCH_H__
...
#include <prtos_errno.h> /* For -ENOSYS or -EOVERFLOW */

#include <public_sysctl.h> /* For LIVEPATCH_OPAQUE_SIZE */
...
#define ELF_LIVEPATCH_PRTOS_DEPENDS ".livepatch.prtos_depends"
...
int livepatch_op(struct prtos_sysctl_livepatch_op *);
...
#include <public_sysctl.h> /* For struct livepatch_func. */
...
static inline int livepatch_op(struct prtos_sysctl_livepatch_op *op)
{
    return -ENOSYS;
}
