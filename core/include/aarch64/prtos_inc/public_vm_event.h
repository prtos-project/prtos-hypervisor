...
#ifndef _PRTOS_PUBLIC_VM_EVENT_H
#define _PRTOS_PUBLIC_VM_EVENT_H
 ...
 * PRTOS will switch the vCPU to on the occurance of the first singlestep, after
...
#endif /* _PRTOS_PUBLIC_VM_EVENT_H */
