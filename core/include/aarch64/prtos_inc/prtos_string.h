#ifndef __PRTOS_STRING_H__
#define __PRTOS_STRING_H__

#include <prtos_types.h>	/* for size_t */
 ...
 */
#define strcpy  __prtos_has_no_strcpy__
#define strcat  __prtos_has_no_strcat__
#define strncpy __prtos_has_no_strncpy__
#define strncat __prtos_has_no_strncat__
