...
/******************************************************************************
 * PRTOS Hypervisor Filesystem
 *
 * Copyright (c) 2019, SUSE Software Solutions Germany GmbH
 *
 */

#ifndef __PRTOS_PUBLIC_HYPFS_H__
#define __PRTOS_PUBLIC_HYPFS_H__
...
#define PRTOS_HYPFS_VERSION      1

/* Maximum length of a path in the filesystem. */
#define PRTOS_HYPFS_MAX_PATHLEN  1024

struct prtos_hypfs_direntry {
    uint8_t type;
#define PRTOS_HYPFS_TYPE_DIR     0
#define PRTOS_HYPFS_TYPE_BLOB    1
#define PRTOS_HYPFS_TYPE_STRING  2
#define PRTOS_HYPFS_TYPE_UINT    3
#define PRTOS_HYPFS_TYPE_INT     4
#define PRTOS_HYPFS_TYPE_BOOL    5
    uint8_t encoding;
#define PRTOS_HYPFS_ENC_PLAIN    0
#define PRTOS_HYPFS_ENC_GZIP     1
...
typedef struct prtos_hypfs_direntry prtos_hypfs_direntry_t;

struct prtos_hypfs_dirlistentry {
    prtos_hypfs_direntry_t e;
    ...
    char name[PRTOS_FLEX_ARRAY_DIM];
};
 ...
 * <0: negative PRTOS errno value
 */
#define PRTOS_HYPFS_OP_get_version     0
 ...
 * caller (struct prtos_hypfs_direntry with the contents following directly
 * after it).
 ...
 * The contents of a directory are multiple struct prtos_hypfs_dirlistentry
 * items.
 *
 * arg1: PRTOS_GUEST_HANDLE(path name)
 * arg2: length of path name (including trailing zero byte)
 * arg3: PRTOS_GUEST_HANDLE(data buffer written by hypervisor)
 ...
 * <0 : negative PRTOS errno value
 */
#define PRTOS_HYPFS_OP_read              1

/*
 * PRTOS_HYPFS_OP_write_contents
 *
 ...
 * arg1: PRTOS_GUEST_HANDLE(path name)
 * arg2: length of path name (including trailing zero byte)
 * arg3: PRTOS_GUEST_HANDLE(content buffer read by hypervisor)
 ...
 * <0 : negative PRTOS errno value
 */
#define PRTOS_HYPFS_OP_write_contents    2

#endif /* __PRTOS_PUBLIC_HYPFS_H__ */
