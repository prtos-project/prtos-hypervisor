...
#ifndef __PRTOS_IOREQ_H__
#define __PRTOS_IOREQ_H__
...
#define NR_IO_RANGE_TYPES (PRTOS_DMOP_IO_RANGE_PCI + 1)
...
int ioreq_server_dm_op(struct prtos_dm_op *op, struct domain *d, bool *const_op);
