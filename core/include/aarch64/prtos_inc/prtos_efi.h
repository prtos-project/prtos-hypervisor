#ifndef __PRTOS_EFI_H__
#define __PRTOS_EFI_H__
...
#ifndef COMPAT
int efi_get_info(uint32_t idx, union prtospf_efi_info *info);
int efi_runtime_call(struct prtospf_efi_runtime_call *op);
#endif
