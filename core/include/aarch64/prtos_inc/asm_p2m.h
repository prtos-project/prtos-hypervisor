...
#ifdef _PRTOS_P2M_COMMON_H
# error "prtos_p2m-common.h should not be included directly"
#endif
#include <prtos_p2m-common.h>

#if defined(CONFIG_MMU)
# include <asm_mmu_p2m.h>
#else
    ...
    struct domain *d, unsigned long gfn, p2m_type_t *t, p2m_query_t q)
{
    ...
    /*
     * Special case for DOMID_PRTOS as it is the only domain so far that is
     * not auto-translated.
     */
    if ( likely(d != dom_prtos) )
    ...
    *t = p2m_invalid;
    ...
    /*
     * DOMID_PRTOS sees 1-1 RAM. The p2m_type is based on the type of the
     * page.
     */
    mfn = _mfn(gfn);
