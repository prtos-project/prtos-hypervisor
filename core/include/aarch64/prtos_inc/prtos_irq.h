#ifndef __PRTOS_IRQ_H__
#define __PRTOS_IRQ_H__
...
/* ===============================
 * Static IRQ routing (optional)
 * =============================== */

struct static_irq_guest;

enum static_irq_type {
    STATIC_IRQ_HYP = 0, /* handled by PRTOS */
    STATIC_IRQ_DIRECT,  /* direct switch to guest (unused for now) */
    STATIC_IRQ_VIRTUAL, /* inject into VGIC */
};

struct static_irq_map {
    uint32_t irq;
    struct static_irq_guest *guest;
