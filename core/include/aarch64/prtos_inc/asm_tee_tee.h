/*
 * core/include/aarch64/prtos_inc/asm_tee_tee.h
 *
...
struct tee_mediator_desc {
    ...
    /*
     * ID of TEE. Corresponds to prtos_arch_domainconfig.tee_type.
     * Should be one of PRTOS_DOMCTL_CONFIG_TEE_xxx
     */
    uint16_t tee_type;
};
...
{
    if ( likely(tee_type == PRTOS_DOMCTL_CONFIG_TEE_NONE) )
        return 0;
...
{
    return PRTOS_DOMCTL_CONFIG_TEE_NONE;
}
