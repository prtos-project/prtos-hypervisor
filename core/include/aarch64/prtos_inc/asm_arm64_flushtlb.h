 ...
 * take any risk.
 *
 * For PRTOS page-tables the ISB will discard any instructions fetched
...
TLB_HELPER(flush_prtos_tlb_local, alle2, nsh)

/* Flush TLB of local processor for address va. */
TLB_HELPER_VA(__flush_prtos_tlb_one_local, vae2)

/* Flush TLB of all processors in the inner-shareable domain for address va. */
TLB_HELPER_VA(__flush_prtos_tlb_one, vae2is)
