...
{
#ifndef NDEBUG
    printk_once(PRTOSLOG_G_WARNING "gnttab_mark_dirty not implemented yet\n");
#endif
}
...
/*
 * The region used by PRTOS on the memory will never be mapped in DOM0
...
#define gnttab_shared_gfn(d, t, i)                                       \
    page_get_prtosheap_gfn(gnttab_shared_page(t, i))

#define gnttab_status_gfn(d, t, i)                                       \
    page_get_prtosheap_gfn(gnttab_status_page(t, i))
