...
// Raised by PRTOS when an internal fatal error is detected
#define PRTOS_HM_EV_FATAL_ERROR 0  // affects PRTOS
...
#define PRTOS_HM_EV_FP_ERROR 3

// Try to access to the PRTOS's memory space
#define PRTOS_HM_EV_MEM_PROTECTION 4

// Unexpected trap raised
#define PRTOS_HM_EV_UNEXPECTED_TRAP 5

#define PRTOS_HM_MAX_GENERIC_EVENTS 6
...
#define PRTOSC_GET_REVISION(_v) ((_v)&0xFF)
    ...
    prtos_address_t partition_table_offset;
    prtos_s32_t num_of_partitions;
    prtos_address_t boot_partition_table_offset;
...
extern struct prtos_conf_part *prtos_conf_partition_table;
extern struct prtos_conf_boot_part *prtos_conf_boot_partition_table;
