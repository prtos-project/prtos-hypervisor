...
prtos_s8_t *hm_event_to_str[PRTOS_HM_MAX_EVENTS] = {
    ...
    FILL_TAB(PRTOS_HM_EV_ARM_UNDEF_INSTR),
    FILL_TAB(PRTOS_HM_EV_ARM_PREFETCH_ABORT),
    FILL_TAB(PRTOS_HM_EV_ARM_DATA_ABORT),
    FILL_TAB(PRTOS_HM_EV_ARM_DATA_ALIGNMENT_FAULT),
    FILL_TAB(PRTOS_HM_EV_ARM_DATA_BACKGROUND_FAULT),
    FILL_TAB(PRTOS_HM_EV_ARM_DATA_PERMISSION_FAULT),
    FILL_TAB(PRTOS_HM_EV_ARM_INSTR_ALIGNMENT_FAULT),
    FILL_TAB(PRTOS_HM_EV_ARM_INSTR_BACKGROUND_FAULT),
    FILL_TAB(PRTOS_HM_EV_ARM_INSTR_PERMISSION_FAULT),
#endif
};
